...
| Settings and appearance | `components/OptionsMenu.tsx`, `state/playerState.ts`, `state/themeController.ts` | `playerSettingsBridge.ts`, `services/settings.ts`, `services/secrets.ts` |
