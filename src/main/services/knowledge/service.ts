...
import type { KnowledgeSettings, SettingsStore } from '../settings'
...
import type { JlptCoverageSourceStatus } from '../../../shared/jlptCoverage'
import type { KnowledgeDb } from './store'
import {
...
import { isStale, canSyncNow } from './levels'
import { createWaniKaniClient, WaniKaniAuthError } from '../wanikani/client'
import { syncWaniKani } from '../wanikani/sync'
import { syncAnki } from './ankiSource'
import { createAnkiClient } from '../anki/ankiConnect'
import {
  createJlptCoverageReportService,
  type JlptCoverageReportService
} from '../jlpt/coverageService'
import type { JlptVocabularySnapshot } from '../jlpt/classifier'
import { createJlptExportService, type JlptExportService } from '../jlpt/exportService'
import type { JlptKanjiSnapshot } from '../jlpt/kanji'
 ...
 * interacts with it.
 */
export function createKnowledgeService(deps: CreateKnowledgeServiceDeps) {
