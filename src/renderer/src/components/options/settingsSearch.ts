...
export type { SettingEntry } from './types'
...
// reachable without knowing which tab holds it. OptionsMenu assembles the
// tab-owned entry lists; only the pure matcher lives here, so it can be tested
