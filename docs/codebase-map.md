...
| Jimaku subtitle discovery | `shared/jimaku.ts` (normalized entries, files, and error results) | `services/jimaku/client.ts` (fixed-origin read-only API client; download URLs remain main-only) |
