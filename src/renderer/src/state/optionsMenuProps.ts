...
export function buildOptionsMenuProps({
  ...
  return {
    ...
    anki: {
      ...
      onPreviewJlptBackfill: actions.onPreviewJlptBackfill,
      onApplyJlptBackfill: actions.onApplyJlptBackfill,
      onJlptBackfillProgress: actions.onJlptBackfillProgress,
