// Anki known-words reader: reads every card in a configured deck and
// full-replaces the 'anki' source in the knowledge DB. Shape mirrors
...
// paginated API — no live AnkiConnect in a test, see
